 ...
 * la baraja, los jugadores, el número de rondas. Contiene métodos llevar el
 * propio juego, mostrar información de la ronda, la toma de decisiones y los
...
public class GestorPartida {
	...
	/**
	 * 
	 * Constructor que define la consola y baraja que se van a usar, además de
	 * definir el estado inicial de las decisiones.
	 * 
	...
	/**
	 * Este método es el encargado de la ejecución del juego, es donde se llaman a
	 * los demás métodos y se controla el flujo de ejecución.
	 */
	public void juego() {
		int partida;
		boolean fin;
	...
	/**
	 * Se encarga de recopilar la información de las decisiones de los jugadores y
	 * llamar al método de repartoRonda para realizar las acciones pertinentes.
	 */
	...
	/**
	 * Realiza el reparto inicial de las cartas según la elección de los jugadores.
	 */
	...
	/**
	 * 
	 * Es la encargada de recoger el caracter que define si quiere carta o se planta
	 * 
	...
	/**
	 * 
	 * Es la encargada de dar cartas a quienes lo hayan pedido y de modificar el
	 * estado de plantado de cada jugador
	 * 
	...
	/**
	 * Define a los jugadores al inicio de la partida, pidiendo un apodo para cada
	 * jugador, y crea una mano para cada uno.
	 */
	...
	public void mostrarGanador() {
		...
		System.out.printf("\nRESULTADO FINAL:\n %s: %d puntos %s\n %s: %d puntos %s\n\n", jugador1.getApodo(), punt1,
				jugador1.estaPasado() ? "(SE HA PASADO)" : "", jugador2.getApodo(), punt2,
				jugador2.estaPasado() ? "(SE HA PASADO)" : "");
